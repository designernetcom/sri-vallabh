...
let beginId = document.getElementById("beginMobile")
let strugId = document.getElementById("strugMobile")
let expId = document.getElementById("expMobile")


console.log("hello")
beginId.addEventListener("click", function (){

  document.getElementById("beg").style.display = "block"
});

strugId.addEventListener("click", function (){

  document.getElementById("strug").style.display = "block"
});

expId.addEventListener("click", function (){
